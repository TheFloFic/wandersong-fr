...
# Comment ça marche ?
- Premièrement, télécharger la dernière release : [https://github.com/TheFloFic/wandersong-fr/releases/download/V1.3.0/WandersongFR_V1.3.zip](https://github.com/TheFloFic/wandersong-fr/releases/download/V1.3.0/WandersongFR_V1.3.zip)
